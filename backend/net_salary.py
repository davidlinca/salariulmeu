...
def calculate_net_salary(gross_salary, meal_tickets=0, ticket_value=0.0, tax_exempt=False, dependents=0, children=0, gross_min_salary=3700):
    """
    ...
    personal_deduction = calculate_personal_deduction(gross_salary, dependents, children, gross_min_salary)

    if not tax_exempt:
        taxable_base = gross_salary - cas - cass - personal_deduction
        iv = taxable_base * IV_RATE
    else:
        iv = 0
    ...
    net_salary = gross_salary - cas - cass - iv + ticket_total - ticket_tax

    return round(net_salary, 2), round(cas, 2), round(cass, 2), round(iv, 2), round(ticket_tax, 2)
